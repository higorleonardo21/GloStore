...
public class HomeFragment extends Fragment implements OnItemClickListener {
  ...
  public HomeFragment(OnFavoritesListener listener){
  ...
  public void onItemClick(String idProduct) {
    // show details dialog
    DetailsDialog.getInstance(idProduct, getFragmentManager(),listener);
  }

  @Override
  public void onItemClickFavorites(boolean state,String idProduct) {
